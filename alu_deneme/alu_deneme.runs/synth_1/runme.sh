...
HD_PWD='C:/Users/doguk/Desktop/udemy fpga vhdl/alu_deneme/alu_deneme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_deneme.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_deneme.tcl
